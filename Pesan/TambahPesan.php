...
if(isset($_POST['proses_tambah'])){
    ...
    mysqli_query($koneksi, "INSERT INTO TambahPesan SET
    idPesan = '$idPesan',
...
$result = mysqli_query($koneksi, "SELECT * FROM TambahPesan");
...
if (isset($_GET['hapus'])) {
    ...
    mysqli_query($koneksi, "DELETE FROM TambahPesan WHERE idPesan = '$idPesan'");
    header("Location: TambahPesan.php");
}
?>
